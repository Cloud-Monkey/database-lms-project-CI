...
# query 7 - select all records where composer is buddy guy
# cursor.execute('SELECT * FROM "Track" WHERE "Composer" = %s ', ["Buddy Guy"])

# query 8 - attempt to select records from a composer that is not in the database
